...
define (['jquery', 'd3', 'lodash'], function ($, d3, _) {
    ...
    function generate_attestation_colors_css (d3_scale) {
        ...
        var style = _.map (_.zip (d3_scale.domain (), d3_scale.range ()), function (pair) {
            ...
            return '.fg_labez[data-labez="' + code + '"] { color: ' + pair[1] + ' !important; fill: ' + pair[1] + '; }\n' +
                '.bg_labez[data-labez="' + code + '"] { background-color: ' + pair[1] + ' !important; }';
        });
    ...
    function insert_css_attestation_colors (d3_scale) {
