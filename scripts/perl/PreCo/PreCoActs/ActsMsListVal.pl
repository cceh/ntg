...
my $target = '`ECM_Acts_Mss`.`ActsMsListValPh2`'; # ggf. Phase 2
my $source1 = '`ECM_Acts_CBGM`.`Acts'.$chnstr.'att`';
my $source2 = '`ECM_Acts_Base`.`05'.$chnstr.'Rdg`';
my $source3 = '`ECM_Acts_Mss`.`ActsMsList`';
