...
my $source = '`ECM_Acts_CBGM`.`Acts'.$chnstr.'att`';    # z.B. ECM_Acts_CBGM.Acts01att

my $target1 = '`ECM_Acts_Base`.`05'.$chnstr.'VP`';      # z.B. ECM_Acts_Base.0501VP
my $target2 = '`ECM_Acts_Base`.`05'.$chnstr.'Rdg`';     # z.B. ECM_Acts_Base.0501Rdg
my $target3 = '`ECM_Acts_Base`.`05'.$chnstr.'Witn`';    # z.B. ECM_Acts_Base.0501Witn
