...
my $source11 = '`VarGenAtt_ActPh2`.`LocStemEdAct'.$chapstr.'`';
my $source12 = '`VarGenAtt_ActPh2`.`VarGenAttAct'.$chapstr.'`';
my $source2 = '`ECM_Acts_BasePh2`.`'.$book.$chapstr.'Witn`';
my $target = '`ECM_Acts_BasePh2`.`'.$book.$chapstr.'WitGen`';
