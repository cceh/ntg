...
### empty target table
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0501PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0502PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0503PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0504PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0505PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0506PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0507PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0508PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0509PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0510PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0511PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0512PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0513PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0514PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0515PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0516PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0517PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0518PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0519PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0520PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0521PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0522PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0523PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0524PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0525PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0526PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0527PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0528PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0529PotAnc`");
$dbh->do ("TRUNCATE TABLE `ECM_Acts_PotAncPh2`.`0530PotAnc`");
...
### CL2PotAnc: values summarised for all CL including fragments
		...
		$dbh->do ("INSERT INTO `ECM_Acts_PotAncPh2`.`$table` 
						SELECT * FROM `ECM_Acts_VGPh2`.`PotAncestors` ;");
		if ($DEBUG) {
			print "\n".__LINE__."INSERT INTO `ECM_Acts_PotAncPh2`.`$table` SELECT * FROM `ECM_Acts_VGPh2`.`PotAncestors` ;";
		}
	}  #for (@wlist)
...
sub PotAnc 
{
	...
	my $cmd;
	if ($ms != 309450) {
		$cmd = "SELECT PASSAGES FROM `ECM_Acts_VGPh2`.`$bs` WHERE (MS1='$ms' AND MS2='309450') OR (MS1='309450' AND MS2='$ms')";
	} else {
		$cmd =  "SELECT PASSAGES FROM `ECM_Acts_VGPh2`.`$bs` WHERE (MS1='$ms' AND MS2='308080') OR (MS1='308080' AND MS2='$ms')";
	}
	...
	$dbh->do ("TRUNCATE TABLE `ECM_Acts_VGPh2`.`TempTab`");
	...
	while (@ary = $sth->fetchrow_array())
	{
		...
		#if ($ary[4]=$ms) { # das ist doch wohl ein Fehler, gemeint ist:
		if ($ary[4] eq $ms) {
	...
	$dbh->do ("TRUNCATE TABLE `ECM_Acts_VGPh2`.`PotAncestors`");

	$dbh->do ("INSERT INTO `ECM_Acts_VGPh2`.`PotAncestors` 
	...
	$sth = $dbh->prepare ("SELECT * FROM `ECM_Acts_VGPh2`.`PotAncestors`
	...
	while (@ary3=$sth->fetchrow_array()) 
	{
		...
		{ 	
			...
			if ($count == 1) {
				...
				$dbh->do ("UPDATE `ECM_Acts_VGPh2`.`PotAncestors` SET	
							NR='$msa'
							WHERE WITN2='$ary3[2]';");
			} else {	
