...
my $source  = '`ECM_Acts_CBGMPh3`.`Acts'.$chnstr.'att_3`'; #'`ECM_Acts_CBGMPh2`.`Acts'.$chnstr.'att_2`';
my $target1 = '`VarGenAtt_ActPh3`.`LocStemEdAct'.$chnstr.'`'; #'`VarGenAtt_ActPh2`.`LocStemEdAct'.$chnstr.'`';
my $target2 = '`VarGenAtt_ActPh3`.`RdgAct'.$chnstr.'`'; #'`VarGenAtt_ActPh2`.`RdgAct'.$chnstr.'`';
my $target3 = '`VarGenAtt_ActPh3`.`VarGenAttAct'.$chnstr.'`'; #'`VarGenAtt_ActPh2`.`VarGenAttAct'.$chnstr.'`';
