...
my $source1 = '`ECM_Acts_Mss`.`ActsMsList_2`'; # Phase 3
my $source2 = '`ECM_Acts_BasePh3`.`05'.$chnstr2.'WitGen`'; # WitGen!
my $source3 = '`ECM_Acts_BasePh3`.`05'.$chnstr2.'Rdg`';
...
foreach $ms(@msl)
{
	my $target = '`ECM_Acts_Sp_'.$chnstr2.'Ph3`.`Acts'.$chnstr2.'_'.$ms.'`';
