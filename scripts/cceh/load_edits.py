...
if __name__ == '__main__':
    ...
    with db.engine.begin () as conn:
        ...
        executemany (conn, """
        INSERT INTO import_locstem (passage, labez, clique, source_labez, source_clique, original,
                                   sys_period, user_id_start, user_id_stop)
        VALUES (:passage, :labez, :clique, :source_labez, :source_clique, :original,
                :sys_period, :user_id_start, :user_id_stop)
        """, parameters, values)
    ...
    with db.engine.begin () as conn:
        ...
        -- reset original readings, so there won't be duplicated original readings
        -- triggering an integrity error
        UPDATE locstem
        SET original = false
        WHERE pass_id IN (
        ...
        INSERT INTO locstem AS u (pass_id, labez, clique, source_labez, source_clique, original,
                                  sys_period, user_id_start, user_id_stop)
        ...
        UPDATE
        SET (source_labez, source_clique, original, sys_period, user_id_start, user_id_stop) =
            (EXCLUDED.source_labez, EXCLUDED.source_clique, EXCLUDED.original,
        ...
        INSERT INTO locstem_tts AS u (pass_id, labez, clique, source_labez, source_clique, original,
                                     sys_period, user_id_start, user_id_stop)
        SELECT pass_id, labez, clique, source_labez, source_clique, original,
               sys_period, user_id_start, user_id_stop
        FROM import_locstem
